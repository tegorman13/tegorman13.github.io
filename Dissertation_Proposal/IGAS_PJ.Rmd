...
header-includes:
- \usepackage{setspace}
- \captionsetup[figure]{labelfont={stretch=1,small}}
...
```{r ModelFig1, fig.width=9,fig.height=6.0, fig.cap= "(ref:introfig1)"}
...
```{r Task, echo=FALSE,out.width="100%",out.height="100%", fig.cap = "(ref:taskFig1)"}
...
```{r Training, echo=FALSE,fig.height=5.0, fig.width=7,  fig.cap = "(ref:e1train)"}
...
```{r e1Test, echo=FALSE,fig.height=5.0, fig.width=7,  fig.cap = "(ref:e1test1)" }
...
kable(test,align=c("c"),caption = "(ref:e1table)") %>% kableExtra::kable_classic() %>%
  add_header_above(c("","Testing Position"= 4,"Condition Average"= 1))

# kable(test,align=c("c")) %>% kableExtra::kable_classic() %>% 
#   add_header_above(c("","Position 610"= 1,"Position 760"= 1,"Position 835"=1,"Position 910"=1,"total"=1))
```
...
```{r e2test1, echo=FALSE,fig.height=8.0, fig.width=9,  fig.cap = "(ref:e2test1c)" }
# manuscript plot
...
kable(test,align=c("c"),caption = "(ref:e2table1)") %>% kableExtra::kable_classic() %>%
  add_header_above(c("","Testing Position"= 6,"Condition Average"= 1))
...
kable(test,align=c("c"),caption = "(ref:e2table2)") %>% kableExtra::kable_classic() %>%
  add_header_above(c("","Testing Position"= 6,"Condition Average"= 1))
...
```{r e2test2, echo=FALSE,fig.height=6.0, fig.width=7,  fig.cap = "(ref:e2test2c)"}
...
kable(test,align=c("c"),caption = "(ref:e2table3)") %>% kableExtra::kable_classic() %>%
  add_header_above(c("","Testing Position"= 4,"Condition Average"= 1))
...
```{r taskSpace, echo=FALSE,fig.height=9.0, fig.width=8,  fig.cap = "(ref:taskSpace)"}
